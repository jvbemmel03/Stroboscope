...
// pins and variables switching between modes
const int switchPin = 7;
bool vorigeSwitchState = false;

// pins for detecting frequency
...
// function for mapping floating variable
...
void loop() {
  ...
  bool huidigeSwitchState = (digitalRead(switchPin) == HIGH);  // HIGH = manual
